	...
	<div class="wf_header-inner">
		...
		<div class="wf_header-navwrapper">
			<div class="wf_header-navwrapperinner">
							...
							<div class="wf-col-lg-6 wf-col-12">
								<div class="wf_navbar-right">
									<ul class="wf_navbar-list-right">
										...
										<li class="wf_navbar-search-form"><?php do_action('shopire_hdr_product_search'); ?></li>
									</ul>
								</div>
							</div>
							<div class="wf-col-lg-4 wf-col-12">
								<div class="wf_navbar-right">
									<ul class="wf_navbar-list-right">
										...
										<?php do_action('shopire_header_button', array('secondary_class' => 'wf-btn-primary')); ?>
									</ul>
								</div>
							</div>
						</div>
					</div>
					<div class="wf_navbar-wrapper <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','shopway'); endif; ?>">
						<div class="wf-container">
							<div class="wf-row align-items-center">
								...
								<?php endif; ?>
								<div class="wf-col-lg-<?php if(class_exists( 'woocommerce' ) && $shopire_hs_hdr_bcat =='1'): esc_attr_e('9','shopway'); else: esc_attr_e('12','shopway'); endif; ?> wf-col-12">
				...
				<div class="wf_mobilenav wf-d-lg-none <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','shopway'); endif; ?>">
