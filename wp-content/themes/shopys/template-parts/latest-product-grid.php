<?php
/**
 * Latest Product Grid Shortcode
 * Usage: [latest_products limit="12" columns="4" filter="true" cart="true" pagination_type="normal" category="" filter_tabs=""]
 *
 * Shows the most recently published products (sorted by date DESC).
 *
 * @package Shopys
 */

function latest_product_grid_shortcode( $atts ) {
    ...
    <div class="ppg-container"
         data-shortcode="latest_products"
...
add_shortcode( 'latest_products', 'latest_product_grid_shortcode' );

// ── AJAX: paginate latest products without page reload ───────────────────────
add_action( 'wp_ajax_lpg_ajax_paginate',        'lpg_ajax_paginate_handler' );
add_action( 'wp_ajax_nopriv_lpg_ajax_paginate', 'lpg_ajax_paginate_handler' );

function lpg_ajax_paginate_handler() {
