 ...
 * Overrides the default WooCommerce category listing with our premium product grid.
 *
 * @package Shopys
 */
...
$current_cat_slug = isset( $queried_object->slug ) ? $queried_object->slug : '';
$current_cat_name = isset( $queried_object->name ) ? $queried_object->name : '';
$current_cat_desc = isset( $queried_object->description ) ? $queried_object->description : '';
$current_cat_id   = isset( $queried_object->term_id ) ? $queried_object->term_id : 0;
$paged            = get_query_var( 'paged' ) ? get_query_var( 'paged' ) : 1;
$per_page         = 24;

// Pagination type: 'normal' (numbered) or 'infinite' (auto-load on scroll)
// You can override this by adding to functions.php:
//   add_filter( 'shopys_cat_pagination_type', function(){ return 'normal'; } );
$pagination_type  = apply_filters( 'shopys_cat_pagination_type', 'infinite' );
...
// Get sub-categories for the filter tabs (child categories of the current one)
                    ...
                    <div class="primary-content-wrap">
                        ...
                        <div class="ppg-container">
                            ...
                            <div class="ppg-cat-header">
                                <h1 class="ppg-cat-title"><?php echo esc_html( $current_cat_name ); ?></h1>
                                <?php if ( $current_cat_desc ) : ?>
                                    <p class="ppg-cat-desc"><?php echo esc_html( $current_cat_desc ); ?></p>
                                <?php endif; ?>
                            ...
                            <!-- Sub-category Filter Tabs (if any exist) -->
                            <?php if ( ! is_wp_error( $child_cats ) && ! empty( $child_cats ) ) : ?>
                            ...
                            <div class="ppg-no-products">
                                ...
                                <p><?php esc_html_e( 'No products found in this category.', 'shopys' ); ?></p>
                            </div>
                            <?php endif;
                            wp_reset_postdata(); ?>
