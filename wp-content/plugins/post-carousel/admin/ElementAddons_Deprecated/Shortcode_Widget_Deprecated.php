...
class Shortcode_Widget_Deprecated extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
			$shortcode_id = esc_attr( $generator_id ); // Smart Post Show global ID for Shortcode metaboxes.
			...
			echo '<style id="sps_dynamic_' . esc_attr( $shortcode_id ) . '">' . $dynamic_style['dynamic_css'] . '</style>';
