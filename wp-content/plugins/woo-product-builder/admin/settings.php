            ...
            <form class="vi-ui form" method="post" action="">
                ...
                <div class="vi-ui bottom attached tab segment " data-tab="email">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'enable_email' ) ) ?>"><?php esc_html_e( 'Enable', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'email_from' ) ) ?>"><?php esc_html_e( 'From', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <div class="field">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'email_subject' ) ) ?>"><?php esc_html_e( 'Subject', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <div class="field">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'message_body' ) ) ?>"><?php esc_html_e( 'Message Body', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <div class="field">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'message_success' ) ) ?>"><?php esc_html_e( 'Message thank you', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <div class="field">
                ...
                <div class="vi-ui bottom attached tab segment active" data-tab="design">
                    ...
                    <table class="form-table vi-ui form">
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'button_text_color' ) ) ?>"><?php esc_html_e( 'Text color', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <input class="color-picker" type="text"
                                       ...
                                       style="background-color: <?php echo esc_attr( self::get_option_field( 'pagination_text_color', '#fff' ) ); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'button_bg_color' ) ) ?>"><?php esc_html_e( 'Background color', 'woo-product-builder' ) ?></label>
                            </th>
                            <td>
                                <input class="color-picker" type="text"
                                       ...
                                       style="background-color: <?php echo esc_attr( self::get_option_field( 'pagination_bg_color', '#04747a' ) ); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'button_main_text_color' ) ) ?>"><?php esc_html_e( 'Primary text color', 'woo-product-builder' ); ?></label>
                            </th>
                            <td>
                                <input class="color-picker" type="text"
                                       ...
                                       style="background-color: <?php echo esc_attr( self::get_option_field( 'preview_text_color', '#fff' ) ); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'button_main_bg_color' ) ) ?>"><?php esc_html_e( 'Primary background color', 'woo-product-builder' ); ?></label>
                            </th>
                            <td>
                                <input class="color-picker" type="text"
                                       ...
                                       style="background-color: <?php echo esc_attr( self::get_option_field( 'preview_bg_color', '#4b9989' ) ); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'button_icon' ) ) ?>"><?php esc_html_e( 'Button Icon', 'woo-product-builder' ); ?></label>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'custom_css' ) ) ?>"><?php esc_html_e( 'Custom CSS', 'woo-product-builder' ); ?></label>
                            </th>
                            <td>
                    ...
                    <table class="form-table vi-ui form">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'mobile_bar_text_color' ) ) ?>">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'mobile_bar_bg_color' ) ) ?>">
                    ...
                    <table class="form-table vi-ui form">
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'share_link' ) ) ?>"><?php esc_html_e( 'Display share link', 'woocommerce-product-builder' ); ?></label>
                            </th>
                            <td>
                                <a class="vi-ui button yellow" target="_blank" href="https://1.envato.market/M3Wjq">
		                            <?php echo esc_html__( 'Unlock This Feature', 'woo-product-builder' ) ?>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'get_short_share_link' ) ) ?>"><?php esc_html_e( 'Display get short share link for customer', 'woocommerce-product-builder' ); ?></label>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'time_to_remove_short_share_link' ) ) ?>"><?php esc_html_e( 'Remove short share link records after x day(s)', 'woocommerce-product-builder' ); ?></label>
                            </th>
                            <td>
                                <a class="vi-ui button yellow" target="_blank" href="https://1.envato.market/M3Wjq">
		                            <?php echo esc_html__( 'Unlock This Feature', 'woo-product-builder' ) ?>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'remove_session' ) ) ?>"><?php esc_html_e( 'Clear session', 'woocommerce-product-builder' ); ?></label>
                            </th>
                            <td>
                                <div class="vi-ui checkbox toggle">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_option_field( 'clear_filter' ) ) ?>"><?php esc_html_e( 'Clear filter', 'woocommerce-product-builder' ); ?></label>
                            </th>
                            <td>
                                <a class="vi-ui button yellow" target="_blank" href="https://1.envato.market/M3Wjq">
		                            <?php echo esc_html__( 'Unlock This Feature', 'woo-product-builder' ) ?>
