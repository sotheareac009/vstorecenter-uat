...
//		flush_rewrite_rules();
	...
	public function woo_product_builder_load_permalinks() {
		if ( isset( $_POST['wpb2205_cpt_base'] ) ) {// phpcs:ignore WordPress.Security.NonceVerification.Missing
			update_option( 'wpb2205_cpt_base', sanitize_title_with_dashes( $_POST['wpb2205_cpt_base'] ) );// phpcs:ignore WordPress.Security.NonceVerification.Missing
			flush_rewrite_rules();
		}
	...
	public function admin_enqueue_script() {
		...
		if ( ( get_post_type() == 'woo_product_builder' && $screen->id == 'woo_product_builder' ) || $page == 'woocommerce-product-builder-setting' ) {
			...
			wp_enqueue_style( 'woocommerce-product-builder-form', VI_WPRODUCTBUILDER_F_CSS . 'form.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-table', VI_WPRODUCTBUILDER_F_CSS . 'table.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-dropdown', VI_WPRODUCTBUILDER_F_CSS . 'dropdown.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-dimmer', VI_WPRODUCTBUILDER_F_CSS . 'dimmer.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-modal', VI_WPRODUCTBUILDER_F_CSS . 'modal.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-checkbox', VI_WPRODUCTBUILDER_F_CSS . 'checkbox.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-menu', VI_WPRODUCTBUILDER_F_CSS . 'menu.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-segment', VI_WPRODUCTBUILDER_F_CSS . 'segment.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-button', VI_WPRODUCTBUILDER_F_CSS . 'button.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-transition', VI_WPRODUCTBUILDER_F_CSS . 'transition.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-tab', VI_WPRODUCTBUILDER_F_CSS . 'tab.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woocommerce-product-builder-input', VI_WPRODUCTBUILDER_F_CSS . 'input.min.css', [], VI_WPRODUCTBUILDER_F_VERSION );
			wp_enqueue_style( 'woo-product-builder', VI_WPRODUCTBUILDER_F_CSS . 'woo-product-builder-admin-product.css', [], VI_WPRODUCTBUILDER_F_VERSION );

			wp_enqueue_script( 'woocommerce-product-builder-transition', VI_WPRODUCTBUILDER_F_JS . 'transition.min.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-checkbox', VI_WPRODUCTBUILDER_F_JS . 'checkbox.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-dropdown', VI_WPRODUCTBUILDER_F_JS . 'dropdown.min.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-dimmer', VI_WPRODUCTBUILDER_F_JS . 'dimmer.min.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-modal', VI_WPRODUCTBUILDER_F_JS . 'modal.min.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-address', VI_WPRODUCTBUILDER_F_JS . 'jquery.address-1.6.min.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			wp_enqueue_script( 'woocommerce-product-builder-tab', VI_WPRODUCTBUILDER_F_JS . 'tab.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			/*Color picker*/
			wp_enqueue_script(
				...
				'jquery-ui-slider',
				'jquery-touch-punch'
			), VI_WPRODUCTBUILDER_F_VERSION, 1
			);
			if ( $page == 'woocommerce-product-builder-setting' ) {
				wp_enqueue_script( 'woocommerce-product-builder-admin-product', VI_WPRODUCTBUILDER_F_JS . 'woo-product-builder-admin.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );

			} else {
				wp_enqueue_script( 'woocommerce-product-builder-admin-product', VI_WPRODUCTBUILDER_F_JS . 'woo-product-builder-admin-product.js', array( 'jquery' ), VI_WPRODUCTBUILDER_F_VERSION, false );
			}
			$arg_scripts = array(
		...
		wp_enqueue_style( 'woocommerce-product-builder-admin-update', VI_WPRODUCTBUILDER_F_CSS . 'woo-product-builder-admin-update.css', [], VI_WPRODUCTBUILDER_F_VERSION );
	...
	public function add_product_builder_metaboxes() {
		...
		add_meta_box(
			'vi_wpb_side_bar', __( 'General', 'woo-product-builder' ), array(
			$this,
                        ...
                        <div class="vi-ui active tab" data-tab="first">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td><?php esc_html_e('Select Categories:', 'woocommerce-product-builder'); ?></td>
                                    <td>
                                        <div class="woopb-tab-inner woopb-tab-selected-items woopb-tab-selected-categories"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><?php esc_html_e('Select Products:', 'woocommerce-product-builder'); ?></td>
                                    <td>
                                        <div class="woopb-tab-inner woopb-tab-selected-items woopb-tab-selected-products"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><?php esc_html_e('Step icon:', 'woocommerce-product-builder'); ?></td>
	...
	public function products_per_page_html() { ?>
        <table class="form-table vi-ui form">
            <tr valign="top">
                <th scope="row">
                    <label for="<?php echo esc_attr( self::set_field( 'product_per_page' ) ) ?>"><?php esc_html_e( 'Product per page', 'woo-product-builder' ) ?></label>
                </th>
                <td>
                    <input type="number" id="<?php echo esc_attr( self::set_field( 'product_per_page' ) ) ?>" name="<?php echo esc_attr( self::set_field( 'product_per_page' ) ) ?>"
                           value="<?php echo esc_attr( self::get_field( 'product_per_page', 10 ) ) ?>" min="1"/>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                    <label for="<?php echo esc_attr( self::set_field( 'product_compatible' ) ) ?>"><?php esc_html_e( 'Depend', 'woo-product-builder' ) ?></label>
                </th>
                <td>
                    <a class="vi-ui button yellow" href="https://1.envato.market/M3Wjq" target="_blank"><?php echo esc_html__( 'Unlock This Feature', 'woo-product-builder' ) ?></a>
	...
	public function general_setting_html() { ?>
        <table class="form-table vi-ui form">
            <tr valign="top">
                <th scope="row">
                    <label for="<?php echo esc_attr( self::set_field( 'text_prefix' ) ); ?>"><?php esc_html_e( 'Text prefix each step', 'woo-product-builder' ) ?></label>
                </th>
                <td>
                    <input type="text" name="<?php echo esc_attr( self::set_field( 'text_prefix' ) ); ?>" id="<?php echo esc_attr( self::set_field( 'text_prefix' ) ); ?>"
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="<?php echo esc_attr( self::set_field( 'enable_quantity' ) ); ?>"><?php esc_html_e( 'Quantity field', 'woo-product-builder' ) ?></label>
                </th>
                <td>
                    <div class="vi-ui toggle checkbox checked">
                        <input type="checkbox" name="<?php echo esc_attr( self::set_field( 'enable_quantity' ) ); ?>"
                               id="<?php echo esc_attr( self::set_field( 'enable_quantity' ) ); ?>" <?php checked( self::get_field( 'enable_quantity' ), 1 ); ?> value="1">
                        <label for="<?php echo esc_attr( self::set_field( 'enable_quantity' ) ); ?>"><?php esc_html_e( 'Enable', 'woo-product-builder' ) ?></label>
                    </div>
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="<?php echo esc_attr( self::set_field( 'enable_preview' ) ); ?>"><?php esc_html_e( 'Preview button', 'woo-product-builder' ) ?></label>
                </th>
                <td>
                    <div class="vi-ui toggle checkbox checked">
                        <input type="checkbox" name="<?php echo esc_attr( self::set_field( 'enable_preview' ) ); ?>"
                               id="<?php echo esc_attr( self::set_field( 'enable_preview' ) ); ?>" <?php checked( self::get_field( 'enable_preview' ), 1 ); ?> value="1">
                        <label for="<?php echo esc_attr( self::set_field( 'enable_preview' ) ); ?>"><?php esc_html_e( 'Enable', 'woo-product-builder' ) ?></label>
                    </div>
