...
<div class="wf-tab-content" data-id="<?php echo esc_attr($target_id);?>">
	<div class="wf-tab-content_customize_pro">
		<h2><?php esc_html_e('Basic dispatch label template','print-invoices-packing-slip-labels-for-woocommerce');?></h2>
		<p><?php esc_html_e('Preview of your dispatch label template.','print-invoices-packing-slip-labels-for-woocommerce');?></p>
	</div>
	<div class="wf-tab-content-inner">
		<form method="post" class="wf_settings_form">
			<div class="wt_dispatch_label_preview">
				<img src="<?php echo esc_url(WF_PKLIST_PLUGIN_URL . 'assets/images/dispatchlabel-sample.svg'); ?>" alt="<?php esc_attr_e('Dispatch Label Preview', 'print-invoices-packing-slip-labels-for-woocommerce'); ?>" style="max-width: 100%; height: auto; padding: 5px;background: #fff;">
			</div>
				<?php
					// Set nonce:
		...
		<?php
			if(false === $pro_installed){
				...
				$packinglist_pro_feature_list = array(
					__('Sort and group items in the product table','print-invoices-packing-slip-labels-for-woocommerce'),
					__('Display product variations, SKUs, and meta details','print-invoices-packing-slip-labels-for-woocommerce'),
					__('Add additional product meta, order meta, product attributes & custom notes','print-invoices-packing-slip-labels-for-woocommerce'),
					__('Customize document layout and add footer section','print-invoices-packing-slip-labels-for-woocommerce'),
					__('Add print button to order emails for faster access','print-invoices-packing-slip-labels-for-woocommerce'),
				);
			?>
						...
						<div class="wt_customizer_pro_addon_widget_wrapper_doc">
							<div class="wt_customizer_pro_addon_widget_wrapper_doc_logo_title">
								...
								<div class="wt_customizer_pro_addon_widget_wrapper_doc_logo_title_col_2">
									...
									<p><?php esc_html_e('Handle order fulfillment with more control and precision.','print-invoices-packing-slip-labels-for-woocommerce'); ?></p>
								</div>
							</div>
