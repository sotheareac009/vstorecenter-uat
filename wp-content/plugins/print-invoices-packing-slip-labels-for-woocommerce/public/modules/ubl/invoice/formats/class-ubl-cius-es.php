...
if ( !class_exists( '\\Wtpdf\\UBL\\Invoice\\Formats\\UblCiusEs' ) ) {
    class UblCiusEs extends \Wtpdf\Ubl\Documents\Invoice {
        ...
        /**
         * Retrieves the document namespace for the UBL CIUS ES invoice format.
         *
         * This method returns an array containing the XML namespace definitions
         * required for the UBL (Universal Business Language) CIUS ES (Core Invoice Usage Specification for Spain) invoice format.
         *
         ...
         * of the UBL invoice, allowing customization of the formatted elements.
         *
        ...
        /**
         * Retrieves the specification string for the UBL CIUS-ES format.
         *
         * This method returns a specification string that indicates compliance with
         * the European standard EN 16931 and the Spanish CIUS-ES-FACE format version 1.0.0.
         *
         * @return string The specification string for the UBL CIUS-ES format.
         */
        ...
        /**
         * Retrieves the formatted specification for the UBL CIUS ES invoice.
         *
         * This method returns an associative array containing the name and value
         * of the UBL CIUS ES invoice specification. The 'name' key holds the 
         * string 'cbc:CustomizationID', and the 'value' key holds the result of 
        ...
        /**
         * Retrieve the invoice type code.
         *
         * This method returns the type code for the given order.
         *
         * @param object $order The WooCommerce order object.
         ...
         *               - 'value': The value of the invoice type code, retrieved from the order.
         */
         ...
         * into an array structure suitable for UBL (Universal Business Language) CIUS-ES (Core Invoice Usage Specification - Spain).
         *
        ...
        /**
         * Get the formatted legal monetary tax total for the order.
         *
         ...
         * and payable amount. Each amount is provided with the appropriate currency ID.
         *
         ...
         * and formats them into an array suitable for generating UBL (Universal Business Language) 
         * compliant invoice lines.
         *
         * @return array An array of formatted invoice lines.
         *
         * Each invoice line contains:
         * - 'enabled': A boolean indicating if the line is enabled.
         * - 'name': The name of the XML element (e.g., 'cac:InvoiceLine').
         * - 'value': An array of child elements and their values.
         *
         * The child elements of each invoice line include:
         * - 'cbc:ID': The item ID.
         * - 'cbc:InvoicedQuantity': The quantity invoiced, with unit code attributes.
         * - 'cbc:LineExtensionAmount': The total amount for the line, with currency attributes.
         * - 'cac:TaxTotal': The total tax amount for the line, with currency attributes and tax subtotals.
         * - 'cac:Item': The item details, including the name.
         *
         * The tax subtotals include:
         * - 'cbc:TaxableAmount': The taxable amount for the line, with currency attributes.
         * - 'cbc:TaxAmount': The tax amount for the line, with currency attributes.
         * - 'cac:TaxCategory': The tax category details, including ID, name, percentage, and tax scheme.
         */
