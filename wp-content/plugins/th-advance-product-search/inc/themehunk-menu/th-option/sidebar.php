<div class="sidebar-section">
            ...
            <h3 class="hndle ui-sortable-handle">
                <span><?php _e('ThemeHunk Premium Plugins','th-advance-product-search'); ?> </span>
            </h3>
            <p>
            ...
            <hr>
            <div class="section">
                <h3><?php _e('Leave us a review','th-advance-product-search'); ?></h3>
                <p><?php _e('We would love to hear your feedback.','th-advance-product-search'); ?> </p>
                 <a href="<?php echo esc_url('https://www.trustpilot.com/review/themehunk.com')?>" target="_blank" class="sidebar-link"><?php _e('Submit review','th-advance-product-search'); ?></a>

            </div>
            <hr>

            <div class="section">
                <h3><?php _e('Video Tutorials','th-advance-product-search'); ?></h3>
                <p><?php _e('Want a guide? We have video tutorials to walk you through getting started.','th-advance-product-search'); ?> </p>
                <a href="<?php echo esc_url('https://www.youtube.com/channel/UCfgrZG0WxbPn707NumiWxUg?sub_confirmation=1')?>" target="_blank" class="sidebar-link"><?php _e('Watch Videos','th-advance-product-search'); ?></a>
            </div>
            <hr>
