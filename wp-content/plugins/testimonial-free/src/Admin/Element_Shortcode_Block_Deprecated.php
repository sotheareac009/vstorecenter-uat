 ...
 */
class Element_Shortcode_Block_Deprecated {
	/**
	 * Instance
	 *
	 * @since 2.5.2
	 ...
	 * @static
	 *
	 * @var Element_Shortcode_Block_Deprecated The single instance of the class.
	 */
	...
	public function init_widgets() {
		// Register widget.
		\Elementor\Plugin::instance()->widgets_manager->register( new ElementAddons_Deprecated\Shortcode_Widget_Deprecated() );
	}
}

Element_Shortcode_Block_Deprecated::instance();
