	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'title'      => __( 'Export File Type', 'testimonial-free' ),
				'multiple'   => false,
				'options'    => array(
					'csv_file'  => __( 'CSV File', 'testimonial-free' ),
					'json_file' => __( 'JSON File', 'testimonial-free' ),
				),
				'default'    => 'json_file',
	...
	array(
		...
		'fields' => array(
			array(
				'class' => 'spt_import',
				'type'  => 'custom_import',
				'title' => __( 'Import JSON/CSV File To Upload', 'testimonial-free' ),
			),
		),
	)
);
