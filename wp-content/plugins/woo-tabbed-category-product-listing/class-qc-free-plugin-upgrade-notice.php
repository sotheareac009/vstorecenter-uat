	...
	class QcPluginUpgradeToProNotice {
		...
		function func_show_upgrade_link_with_action_links( $links )
		{
			...
			$links = array_merge( $links, array(
				'<a title="Settings" class="'.$this->link_class.'" style="" href="' . esc_url( admin_url('admin.php?page=woo-tab') ) . '" target="">' . __( 'Settings', 'quantumcloud' ) . '</a>'
			) );
...
$instance_sldf2 = new QcPluginUpgradeToProNotice();
...
{ 
	...
	$instance_sldf2->upgrade_link = "https://www.quantumcloud.com/products/woo-tabbed-category-product-listing/";
	...
	$instance_sldf2->plugin_slug = 'woo-tabbed-category-product-listing'; //Plugin Slug. i.e. Folder Name
	$instance_sldf2->plugin_main_file = 'woo-tabbed-category-product-listing.php'; //Primary file of the pluign
	$instance_sldf2->plugin_menu_slug = 'woo-tab'; //Main Menu Slug
