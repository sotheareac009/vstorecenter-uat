...
A [pro version](https://infolific.com/technology/software-worth-using/real-time-find-and-replace-for-wordpress/#pro-version) (a lifetime license is less than $15) with additional filtering options, setting export/import functionality, and the ability to modify admin pages is available.
