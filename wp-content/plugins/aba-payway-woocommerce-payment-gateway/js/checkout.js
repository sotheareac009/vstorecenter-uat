					...
					success:	function( result ) {
						try {
							if ('success' === result.result ) {
								if ( choose_payway_option == 'aba_payway_aim' ) {
									jQuery("#aba_main_modal [name='api_version']").val('');
									jQuery("#aba_main_modal [name='req_time']").val(result.req_time);
									...
									jQuery("#aba_main_modal [name='firstname']").val(result.first_name);
									jQuery("#aba_main_modal [name='lastname']").val(result.last_name);
									jQuery("#aba_main_modal [name='email']").val(result.email);
									jQuery("#aba_main_modal [name='phone']").val(result.phone);
								...
								if (result?.redirect) {
									if (result.redirect.startsWith('https://') || result.redirect.startsWith('http://')) {
										window.location = decodeURI(result.redirect);
									} else {
										alert("Invalid or missing redirect URL.");
									}
								}
