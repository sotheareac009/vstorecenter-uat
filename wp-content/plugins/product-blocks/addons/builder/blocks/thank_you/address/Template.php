	...
	<section class="woocommerce-customer-details">
		<div class="woocommerce-column--billing-address">
			<div class="wopb-billing-shipping-address">
				<h2 class="woocommerce-column__title wopb-address-title "><?php echo esc_html( $attr['billingText'], 'product-blocks' ); ?></h2>
				<address>
		...
		<div class="woocommerce-column--shipping-address">
			<div class="wopb-billing-shipping-address">
				<h2 class="woocommerce-column__title wopb-address-title "><?php echo esc_html( $attr['shippingText'], 'product-blocks' ); ?></h2>
				<address>
