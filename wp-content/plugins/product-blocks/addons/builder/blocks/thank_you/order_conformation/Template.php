	...
	<div class="wopb-thankyou-order-conformation-container">
		<?php if($attr['showHead']) { ?>
			<div class="wopb-order-heading-section" >
				<div class="wopb-order-heading"><?php echo esc_html( $attr['orderHeadText'].$order_id, 'product-blocks' ); ?> </div>
			</div>
		<?php }
		...
		<?php 
			...
			<?php if($attr['showMessage']) { ?>
				<div class="wopb-order-message-section" >
					<div class="wopb-order-message"> <?php echo esc_html( $attr['messageText'], 'product-blocks' ); ?></div>
				</div>
		<?php 
			}
		} ?>
