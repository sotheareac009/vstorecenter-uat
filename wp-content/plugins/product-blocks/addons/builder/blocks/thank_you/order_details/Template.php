...
<section class="woocommerce-order-details">
	...
	<h2 class="woocommerce-order-details__title"><?php echo esc_html( $attr['orderDetailsText'], 'woocommerce' ); ?></h2>

	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">

		<thead>
			<tr>
				<th class="woocommerce-table__product-name product-name"><?php echo esc_html( $attr['productText'], 'woocommerce' ); ?></th>
				<th class="woocommerce-table__product-table product-total"><?php echo esc_html( $attr['totalText'], 'woocommerce' ); ?></th>
			</tr>
		</thead>
